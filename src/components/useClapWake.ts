...
// Rileva il DOPPIO BATTITO DI MANI per risvegliare ORION dallo standby.
// Attivo solo quando `attivo` è true (durante lo standby): apre un flusso audio
// dedicato e cerca due picchi secchi ravvicinati.
