...
- Modalità GESTI (la mano diventa il MOUSE — SOLO Desktop): per "modalità gesti", "voglio usare le mani", "controllo a gesti", "comandare col dito" usa attiva_gesti. Il dito muove il cursore vero su TUTTO il computer (qualsiasi app, sito, Finder, Dock, non solo i pannelli di ORION); il pinch è il tasto del mouse (click / doppio click per aprire / pinch tenuto e trascina per spostare finestre e file, cestinare, selezionare); due mani in pinch ridimensionano la finestra sotto. Serve il permesso Accessibilità (lo chiede la prima volta). È diverso dalla modalità visione (che assiste le attività manuali). Opt-in (telecamera, tutto in locale); a gesti spenti tutto torna come sempre. Sul WEB spiega con garbo che serve ORION Desktop.
